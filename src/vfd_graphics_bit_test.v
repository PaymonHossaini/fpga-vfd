// VFD Bit Pattern Test - Test lower 2 bits systematically
// Tests x values with pattern 0xA8 + offset to isolate bit issues
// Each dot at different y so we can identify which work

module vfd_graphics_bit_test (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Test 0xA8 range (bits [3:2] = 10)
                // Dot 1: x=168 (0xA8), bits [1:0]=00, y=10
                ...
                // Dot 2: x=169 (0xA9), bits [1:0]=01, y=20
                ...
                // Dot 3: x=170 (0xAA), bits [1:0]=10, y=30
                ...
                // Dot 4: x=171 (0xAB), bits [1:0]=11, y=40
                ...
                // Test 0xAC range (bits [3:2] = 11)
                // Dot 5: x=172 (0xAC), bits [1:0]=00, y=60
                ...
                8'd46: begin current_byte = 8'h3C; post_delay = DELAY_SHORT; end  // y=60
                8'd47: begin current_byte = 8'h00; post_delay = DELAY_LONG; end
                
                // Dot 6: x=173 (0xAD), bits [1:0]=01, y=70
                ...
                8'd55: begin current_byte = 8'h46; post_delay = DELAY_SHORT; end  // y=70
                8'd56: begin current_byte = 8'h00; post_delay = DELAY_LONG; end
                
                // Dot 7: x=174 (0xAE), bits [1:0]=10, y=80
                ...
                8'd64: begin current_byte = 8'h50; post_delay = DELAY_SHORT; end  // y=80
                8'd65: begin current_byte = 8'h00; post_delay = DELAY_LONG; end
                
                // Dot 8: x=175 (0xAF), bits [1:0]=11, y=90
                ...
                8'd73: begin current_byte = 8'h5A; post_delay = DELAY_SHORT; end  // y=90
