// VFD Graphics Test - Test failing x coordinates
// Test only x=55, 175, 235 at y=10

module vfd_graphics_test_failing_x (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                10'd8:  begin current_byte = 8'h37; post_delay = DELAY_SHORT; end
                ...
                10'd17: begin current_byte = 8'hAF; post_delay = DELAY_SHORT; end
                ...
                10'd26: begin current_byte = 8'hEB; post_delay = DELAY_SHORT; end
