// VFD Graphics Test v11 - Solid 16x16 block to verify all bytes
// v10 showed top-left L shape, missing bottom and right

module vfd_graphics_v11 (
    ...
    always @(*) begin
        case (byte_idx)
            ...
            // ALL 32 bytes solid - should show 16x16 filled square
            default: current_byte = 8'hFF;
        endcase
    end
