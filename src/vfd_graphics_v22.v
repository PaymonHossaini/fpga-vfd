// VFD Graphics Test v22 - Diagnostic: unique pattern per byte position
// This will help us understand the actual byte mapping

module vfd_graphics_v22 (
    input wire clk,
    ...
    // Smaller: 8x8 image (x=8, y=1) = 8 data bytes
    ...
    always @(*) begin
        case (byte_idx)
            ...
            6'd7: current_byte = 8'h01;  // yL = 1 (8 dots)
            6'd8: current_byte = 8'h00;  // yH = 0
            6'd9: current_byte = 8'h01;  // g = 1
            
            // 8 data bytes - diagonal pattern
            // If D7=top, D0=bottom and data goes column by column:
            // d0: col0, d1: col1, etc.
            6'd10: current_byte = 8'h80;  // col 0: row 0 lit
            6'd11: current_byte = 8'h40;  // col 1: row 1 lit
            6'd12: current_byte = 8'h20;  // col 2: row 2 lit
            6'd13: current_byte = 8'h10;  // col 3: row 3 lit
            6'd14: current_byte = 8'h08;  // col 4: row 4 lit
            6'd15: current_byte = 8'h04;  // col 5: row 5 lit
            6'd16: current_byte = 8'h02;  // col 6: row 6 lit
            6'd17: current_byte = 8'h01;  // col 7: row 7 lit
