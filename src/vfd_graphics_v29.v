// VFD Graphics Test v29 - D0 = top pixel (based on datasheet memory diagram)
// For 16x16: 32 bytes, column-by-column, 2 bytes per column
// Byte order: col0-top, col0-bot, col1-top, col1-bot, ...

module vfd_graphics_v29 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                8'd9: begin current_byte = 8'h02; post_delay = DELAY_SHORT; end  // yL = 2 (16 dots)
                ...
                // 16x16 box outline with D0=top, D7=bottom
                // Column 0: left edge (all on)
                8'd12: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end  // top 8 rows
                8'd13: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end  // bottom 8 rows
                // Columns 1-14: only top row (D0=0x01) and bottom row (D7=0x80)
                8'd14: begin current_byte = 8'h01; post_delay = DELAY_SHORT; end  // col 1 top (D0=top pixel)
                8'd15: begin current_byte = 8'h80; post_delay = DELAY_SHORT; end  // col 1 bot (D7=bottom pixel)
