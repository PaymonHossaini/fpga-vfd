// VFD Graphics Test v31 - Using Dot Unit Command (like Arduino library)
// Command: US ( d 21h = 1F 28 64 21
// This matches GU3000_drawImage_p(x, y, width, height, data) exactly
// Position and size all in single-dot units

module vfd_graphics_v31 (
    input wire clk,
    ...
    // 64 nulls + Init(2) + Clear(1) + DotUnitCmd(13) + 32 data bytes = 112
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot unit real-time bit image display: US ( d 21h
                ...
                8'd6:  begin current_byte = 8'h21; post_delay = DELAY_SHORT; end  // 21h
                
                // Position: (0, 0) - top left corner
                8'd7:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xPL = 0
                8'd8:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xPH = 0
                8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // yPL = 0
                8'd10: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // yPH = 0
                
                // Size: 16x16 pixels (in single-dot units, NOT 8-dot units!)
                ...
                8'd13: begin current_byte = 8'h10; post_delay = DELAY_SHORT; end  // yL = 16 (NOT 2!)
                ...
                // 16x16 box outline image data (32 bytes)
                // Data format: column-by-column, 2 bytes per column
                // First byte = top 8 pixels, Second byte = bottom 8 pixels
                // Within each byte: D0 = top, D7 = bottom (based on datasheet diagram)
                ...
                // Columns 1-14: top and bottom edges only
                // 0x01 = D0 set = top pixel of 8-pixel segment
                // 0x80 = D7 set = bottom pixel of 8-pixel segment
