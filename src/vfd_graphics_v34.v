// VFD Graphics Test v34 - Line using shape command with longer delays
// Uses US ( d 11h with mode=0 (line)
// Command: 1F 28 64 11 mode pen x0L x0H y0L y0H x1L x1H y1L y1H

module vfd_graphics_v34 (
    input wire clk,
    ...
    // 64 nulls + Init(2) + Clear(1) + Line(14) = 81
    localparam NUM_BYTES = 8'd81;
    localparam NUM_NULLS = 8'd64;
    
    localparam DELAY_SHORT = 24'd54000;    // 2ms (increased)
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Line: US ( d 11h mode pen x0L x0H y0L y0H x1L x1H y1L y1H
                // Draw a horizontal line from (10,50) to (100,50)
                ...
                8'd7:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // mode = 0 (LINE)
                ...
                8'd11: begin current_byte = 8'h32; post_delay = DELAY_SHORT; end  // y0L = 50
                8'd12: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // y0H = 0
                8'd13: begin current_byte = 8'h64; post_delay = DELAY_SHORT; end  // x1L = 100
                8'd14: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // x1H = 0
                8'd15: begin current_byte = 8'h32; post_delay = DELAY_SHORT; end  // y1L = 50
