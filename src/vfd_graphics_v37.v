// VFD Graphics Test v37 - Bit image with fixed timing
// Uses US ( d 21h (dot unit real-time bit image)
// Timing: data setup -> WR low -> WR high -> hold delay

module vfd_graphics_v37 (
    input wire clk,
    ...
    // 64 nulls + Init(2) + Clear(1) + DotUnitCmd(13) + 32 data = 112
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // 1F 28 64 21 xPL xPH yPL yPH xL xH yL yH g d(1)...d(k)
                ...
                8'd6:  begin current_byte = 8'h21; post_delay = DELAY_SHORT; end  // 21h (dot unit image)
                
                // Position: (0, 0)
                8'd7:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xPL
                8'd8:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xPH
                8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // yPL
                ...
                // Columns 1-14: top and bottom edges
