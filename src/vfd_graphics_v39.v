// VFD Graphics Test v39 - No null bytes, just init + clear + image
// Removed null byte flushing to see if that's causing issues

module vfd_graphics_v39 (
    input wire clk,
    ...
    // Just: 2 init + 1 clear + 13 cmd + 32 data = 48 bytes
    localparam NUM_BYTES = 8'd48;
