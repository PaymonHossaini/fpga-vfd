// VFD Graphics Test v4 - Correct size parameters
// Tang Nano 20K -> GU256x128C VFD

module vfd_graphics_v4 (
    ...
    // Clear + GU-3000 command with proper size params
    // 0x1F 0x28 0x66 0x11 xL xH yL yH xSize ySize [data]
    // xSize = width in bytes (1 = 8 pixels)
    // ySize = height in pixels (8)
    localparam NUM_BYTES = 6'd19;  // 1 clear + 10 header + 8 data
    ...
    always @(*) begin
        case (byte_idx)
            ...
            6'd9: current_byte = 8'h01;  // xSize = 1 byte (8 pixels wide)
            6'd10: current_byte = 8'h08; // ySize = 8 pixels tall
            
            // 8x8 pixel data (solid block for visibility)
            6'd11: current_byte = 8'hFF;
            6'd12: current_byte = 8'hFF;
            6'd13: current_byte = 8'hFF;
