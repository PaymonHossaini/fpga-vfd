// VFD Graphics Test v42 - Dots first, then image
// If dots work but image doesn't, we know the image command is the issue

module vfd_graphics_v42 (
    input wire clk,
    ...
    // Init(2) + Clear(1) + 1 dot(9) + delay + image(9+32) = 53 bytes
    localparam NUM_BYTES = 8'd53;
    
    localparam DELAY_SHORT = 24'd27000;    // 1ms
    localparam DELAY_LONG  = 24'd810000;   // 30ms
    localparam DELAY_XLONG = 24'd2700000;  // 100ms
    ...
    always @(*) begin
        case (byte_idx)
            ...
            // Draw a dot at (100, 64) - center of screen - to confirm we're working
            ...
            8'd8:  begin current_byte = 8'h64; post_delay = DELAY_SHORT; end  // x = 100
            8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
            8'd10: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // y = 64
            8'd11: begin current_byte = 8'h00; post_delay = DELAY_XLONG; end  // Long delay before image
            
            // Now try image: US ( f 11h
            8'd12: begin current_byte = 8'h1F; post_delay = DELAY_SHORT; end
            8'd13: begin current_byte = 8'h28; post_delay = DELAY_SHORT; end
            8'd14: begin current_byte = 8'h66; post_delay = DELAY_SHORT; end  // f
            8'd15: begin current_byte = 8'h11; post_delay = DELAY_SHORT; end
            8'd16: begin current_byte = 8'h10; post_delay = DELAY_SHORT; end  // width = 16
            8'd17: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
            8'd18: begin current_byte = 8'h02; post_delay = DELAY_SHORT; end  // height = 2 (16 pixels)
            8'd19: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
            8'd20: begin current_byte = 8'h01; post_delay = DELAY_SHORT; end  // g = 1
            
            // 16x16 solid block - all 0xFF for easy visibility
            ...
            8'd34: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd35: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd36: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd37: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd38: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd39: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd40: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd41: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd42: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd43: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd44: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd45: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd46: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd47: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd48: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd49: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd50: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd51: begin current_byte = 8'hFF; post_delay = DELAY_SHORT; end
            8'd52: begin current_byte = 8'hFF; post_delay = DELAY_LONG; end
