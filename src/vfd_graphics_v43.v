// VFD Graphics Test v43 - Extra delay around 0x1F (US) byte
// Theory: 0x1F timing is critical

module vfd_graphics_v43 (
    input wire clk,
    ...
    // Just init + clear + 1 dot
    localparam NUM_BYTES = 8'd12;
    
    localparam DELAY_SHORT  = 24'd27000;    // 1ms
    localparam DELAY_MEDIUM = 24'd135000;   // 5ms
    localparam DELAY_LONG   = 24'd810000;   // 30ms
    localparam SETUP_TIME   = 8'd54;        // 2us (doubled)
    localparam PULSE_TIME   = 8'd108;       // 4us (doubled)
    localparam HOLD_TIME    = 8'd54;        // 2us (doubled)
    ...
    always @(*) begin
        case (byte_idx)
            ...
            // Dot at (50, 50): US ( d 10h
            8'd3:  begin current_byte = 8'h1F; post_delay = DELAY_MEDIUM; end  // US - extra delay after
            ...
            8'd7:  begin current_byte = 8'h01; post_delay = DELAY_SHORT; end   // pen = on
            8'd8:  begin current_byte = 8'h32; post_delay = DELAY_SHORT; end   // x = 50
            8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
            8'd10: begin current_byte = 8'h32; post_delay = DELAY_SHORT; end   // y = 50
