// VFD Graphics Test v48 - Match v35's working pattern exactly
// Use case statement, ESC @, null prefix, 9-byte dot command

module vfd_graphics_v48 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot 2 at (128, 64): 1F 28 64 10 01 80 00 40 00
                ...
                8'd17: begin current_byte = 8'h80; post_delay = DELAY_SHORT; end  // xL=128
