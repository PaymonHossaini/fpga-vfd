// VFD Graphics Test v50 - 4 dots to test if count is the issue
// Just add one more dot to working v48

module vfd_graphics_v50 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                8'd17: begin current_byte = 8'h64; post_delay = DELAY_SHORT; end  // x=100
                ...
                8'd26: begin current_byte = 8'h96; post_delay = DELAY_SHORT; end  // x=150
                ...
                8'd35: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end  // x=200
