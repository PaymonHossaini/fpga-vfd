// VFD Graphics Test v51 - 4 dots with VERY long delays
// Test if buffer overflow is the issue

module vfd_graphics_v51 (
    input wire clk,
    ...
    localparam DELAY_LONG  = 24'd2700000;  // 100ms after commands (was 30ms)
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                8'd8:  begin current_byte = 8'h32; post_delay = DELAY_SHORT; end
                ...
                8'd17: begin current_byte = 8'h64; post_delay = DELAY_SHORT; end
                ...
                8'd26: begin current_byte = 8'h96; post_delay = DELAY_SHORT; end
                ...
                8'd35: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end
