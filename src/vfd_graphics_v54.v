// VFD Graphics Test v54 - Just 2 dots to narrow down the issue
// Exact copy of v48 but with only 2 dots

module vfd_graphics_v54 (
    input wire clk,
    ...
    // 64 nulls + ESC @(2) + CLR(1) + 2 dots × 9 bytes = 85 bytes
    localparam NUM_BYTES = 8'd85;
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot 2 at (200, 64): 1F 28 64 10 01 C8 00 40 00
                ...
                8'd17: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end
