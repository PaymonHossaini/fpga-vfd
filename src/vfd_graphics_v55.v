// VFD Graphics Test v55 - EXACT copy of v48 but dot 2 at different position
// Only change: dot 2 x position from 128 to 100

module vfd_graphics_v55 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot 1 at (50, 64): 1F 28 64 10 01 32 00 40 00
                ...
                8'd7:  begin current_byte = 8'h01; post_delay = DELAY_SHORT; end  // c=1 (display)
                8'd8:  begin current_byte = 8'h32; post_delay = DELAY_SHORT; end  // xL=50
                ...
                // Dot 2 at (100, 64): 1F 28 64 10 01 64 00 40 00  <-- CHANGED from 128
                ...
                8'd16: begin current_byte = 8'h01; post_delay = DELAY_SHORT; end  // c=1 (display)
                8'd17: begin current_byte = 8'h64; post_delay = DELAY_SHORT; end  // xL=100 (was 0x80=128)
                8'd18: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xH=0
                8'd19: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // yL=64
                8'd20: begin current_byte = 8'h00; post_delay = DELAY_LONG; end   // yH=0
                
                // Dot 3 at (200, 64): 1F 28 64 10 01 C8 00 40 00
                ...
                8'd25: begin current_byte = 8'h01; post_delay = DELAY_SHORT; end  // c=1 (display)
                8'd26: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end  // xL=200
                8'd27: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end  // xH=0
                8'd28: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // yL=64
                8'd29: begin current_byte = 8'h00; post_delay = DELAY_LONG; end   // yH=0
