// VFD Graphics Test v56 - Test x=120 (0x78) instead of x=100 (0x64)
// 0x64 might be causing issues since it's part of command prefix

module vfd_graphics_v56 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot 2 at (120, 64): 1F 28 64 10 01 78 00 40 00  <-- x=120 (0x78)
                ...
                8'd17: begin current_byte = 8'h78; post_delay = DELAY_SHORT; end  // xL=120 (0x78)
