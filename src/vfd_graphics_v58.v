// VFD Graphics Test v58 - Test bit 0 specifically
// Same as v48 but first dot at x=51 (0x33) instead of x=50 (0x32)
// 0x32 = 00110010, 0x33 = 00110011 (adds bit 0)

module vfd_graphics_v58 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // Dot 1 at (51, 64) - CHANGED from 50 to test bit 0
                ...
                8'd8:  begin current_byte = 8'h33; post_delay = DELAY_SHORT; end  // x=51 (0x33 vs 0x32)
                8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
                8'd10: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end
                8'd11: begin current_byte = 8'h00; post_delay = DELAY_LONG; end
                
                // Dot 2 at (128, 64) - unchanged
                ...
                8'd17: begin current_byte = 8'h80; post_delay = DELAY_SHORT; end  // x=128
                ...
                8'd26: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end  // x=200
