// VFD Graphics Test v6 - Try different command variants
// Tang Nano 20K -> GU256x128C-3900B VFD

module vfd_graphics_v6 (
    ...
    // Try simpler approach - cursor position then raw pixels
    // Or use ESC sequence for graphics
    ...
    always @(*) begin
        case (byte_idx)
            ...
            // Try: 0x1F 0x28 0x66 0x01 xL xH yL yH mode [data]
            // 0x66 0x01 = Write screen mode
            6'd1: current_byte = 8'h1F;  // US
            6'd2: current_byte = 8'h28;  // (
            6'd3: current_byte = 8'h66;  // f
            6'd4: current_byte = 8'h01;  // Write to screen (not 0x11)
            6'd5: current_byte = 8'h00;  // x = 0
            6'd6: current_byte = 8'h00;  
            6'd7: current_byte = 8'h00;  // y = 0
            6'd8: current_byte = 8'h00;  
            6'd9: current_byte = 8'h08;  // 8 pixels wide
            6'd10: current_byte = 8'h00; 
            6'd11: current_byte = 8'h08; // 8 pixels tall
            6'd12: current_byte = 8'h00; 
            6'd13: current_byte = 8'h01; // mode
            
            // One byte of data - solid
