// VFD Graphics Test v65 - Single dot x-coordinate test (based on v35)
// Tests a single dot with configurable x value
// Change TEST_X to test different coordinates

module vfd_graphics_v65_single_dot (
    input wire clk,
    ...
    // 64 nulls + Init(2) + Clear(1) + 1 dot × 9 bytes = 76
    ...
    // Change TEST_X to test different values
    // Working: 10 (0x0A), 20 (0x14), 30 (0x1E)
    // Test: 100 (0x64), 128 (0x80), etc.
    localparam TEST_X = 8'd100;  // <-- CHANGE THIS TO TEST DIFFERENT X VALUES
