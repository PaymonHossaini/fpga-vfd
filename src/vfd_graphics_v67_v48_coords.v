// VFD Graphics Test v67 - Three dots at v48 coordinates
// Tests x=50, x=128, x=200 to see if it breaks

module vfd_graphics_v67_v48_coords (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                8'd8:  begin current_byte = 8'h32; post_delay = DELAY_SHORT; end  // 50 = 0x32
                8'd9:  begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
                8'd10: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // 64 = 0x40
                8'd11: begin current_byte = 8'h00; post_delay = DELAY_LONG; end
                
                // Dot 2 at (100, 64) - Changed from 128 to 100
                ...
                8'd19: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // 64 = 0x40
                ...
                8'd26: begin current_byte = 8'hC8; post_delay = DELAY_SHORT; end  // 200 = 0xC8
                8'd27: begin current_byte = 8'h00; post_delay = DELAY_SHORT; end
                8'd28: begin current_byte = 8'h40; post_delay = DELAY_SHORT; end  // 64 = 0x40
