// VFD Graphics Test v8 - Solid block to verify column count
// All 0xFF to see exactly what gets displayed

module vfd_graphics_v8 (
    ...
    // Smaller test: 4 pixels wide x 8 tall
    // x=4, y=1 (8 pixels in 8-dot units)
    // k = 4 * 1 * 1 = 4 bytes
    localparam NUM_BYTES = 6'd14;  // 1 clear + 9 header + 4 data
    ...
    always @(*) begin
        case (byte_idx)
            ...
            6'd5: current_byte = 8'h04;  // xL = 4 pixels wide
            ...
            // 4 bytes - all solid to see if all columns appear
            6'd10: current_byte = 8'hFF; // Col 0: solid
            6'd11: current_byte = 8'hFF; // Col 1: solid
            6'd12: current_byte = 8'hFF; // Col 2: solid
            6'd13: current_byte = 8'hFF; // Col 3: solid
