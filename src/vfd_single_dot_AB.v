// VFD Single Dot Test - x=171 (0xAB)
// Testing value just below the failing 0xAC

module vfd_single_dot_AB (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                8'd8:  begin current_byte = 8'hAB; post_delay = DELAY_SHORT; end  // x=171
