// VFD Single Dot Test - JUST 0xAC
// Tests if x=172 (0xAC) works when it's the ONLY dot

module vfd_single_dot_AC (
    input wire clk,
    ...
    // Same timing as v35 (WORKING timing)
    ...
    // 64 nulls + Init(2) + Clear(1) + ONE dot (9 bytes) = 76
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // SINGLE DOT: x=172 (0xAC), y=64 (center of screen)
                // Command: 1F 28 64 10 01 AC 00 40 00
                ...
                8'd8:  begin current_byte = 8'hAC; post_delay = DELAY_SHORT; end  // x=172
