// VFD Single Dot Test - x=50 (0x32), y=57 (0x39)
// Testing the 8th pixel down in drawimage box (missing pixel)

module vfd_single_dot_AC_y60 (
    input wire clk,
    ...
    always @(*) begin
        if (byte_idx < NUM_NULLS) begin
            ...
            case (byte_idx - NUM_NULLS)
                ...
                // SINGLE DOT: x=50 (0x32), y=57 (0x39) - 8th pixel of drawimage box
                ...
                8'd10: begin current_byte = 8'h39; post_delay = DELAY_SHORT; end  // y=57
